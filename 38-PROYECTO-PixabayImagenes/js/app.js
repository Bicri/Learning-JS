...
// 28669620-0618ac907ae8256087378c4f5
...
function buscarImagenes(){
    ...
    const key = '28669620-0618ac907ae8256087378c4f5';
            ...
            <div class="w-1/2 md:w-1/3 lg:w-1/4 p-3 mb-4 ">
                <div class="bg-white">
                    ...
                    <div class="p-4">
                        ...
                        <a href="${largeImageURL}" class="block w-full bg-blue-800 hover:bg-blue-500 text-white uppercase font-bold text-center rounded mt-5 p-1" 
...
function imprimirPaginador(){
    ...
    while(true){
        ...
        //Genera un boton por cada elemento
